...
- `eng/Build.ps1` verified vendored dependency hashes and browser egress boundaries, restored in locked mode, built Release with zero warnings, and passed 94 tests.
