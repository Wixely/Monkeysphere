...
- Core, SQLite integration, and authenticated rendering tests cover map-query bounds, filters, pagination, structured location summaries, and private map access.
