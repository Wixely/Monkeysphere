...
- `eng/Build.ps1` restored in locked mode, built Release with zero warnings, and passed 87 tests.
...
- Core, SQLite integration, and authenticated rendering tests cover map-query bounds, filters, pagination, R-tree migration history, approximation-radius viewport intersection, structured location summaries, and private map access.
