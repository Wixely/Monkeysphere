...
internal sealed class RemoteUploadStore(RemoteUploadConnections connections, IDomainCatalog domains, TimeProvider timeProvider) : IRemoteUploadStore
{
    ...
    {
        if (entry.DomainId == Guid.Empty || entry.Action is not ("uploads.begin" or "uploads.write" or "uploads.seal" or "uploads.complete" or "uploads.cancel" or "uploads.status" or "contacts.preview" or "contacts.inspect" or "contacts.evidence" or "contacts.apply" or "contacts.result" or "contacts.export" or "images.add" or "images.read") ||
